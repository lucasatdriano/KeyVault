...
const getCategoryColor = (category: string) => {
    const colors: Record<string, string> = {
        ...
        Streaming: 'from-red-500 to-red-600',
...
const DeletedCredentialCard: React.FC<DeletedCredentialCardProps> = ({
    ...
    return (
        <>
            <div
                className="bg-white/5 rounded-2xl border border-white/10 hover:border-red-500/20 transition-all p-4 group"
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            <button
                                ...
                                className="cursor-pointer p-2 rounded-xl hover:bg-red-500/10 text-foreground/40 hover:text-red-500 transition-all"
