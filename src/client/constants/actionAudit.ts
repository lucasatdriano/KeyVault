...
export const ACTION_MAP: Record<string, AuditAction> = {
    ...
    verify_email: AuditAction.VERIFY_EMAIL,
    ...
    change_master_password: AuditAction.CHANGE_MASTER_PASSWORD,
    ...
    change_email: AuditAction.CHANGE_EMAIL,
